...
static uint16_t _width  = _TFTWIDTH;
static uint16_t _height = _TFTHEIGHT;



uint16_t frame_buf[160*128];
...
void st7735SetRotation(uint8_t mode)
{
  ...
  {
   case 0:
     st7735WriteData(MADCTL_MX | MADCTL_MY | MADCTL_RGB);
     _width  = _TFTWIDTH;
     _height = _TFTHEIGHT;
     colstart = 0;
     rowstart = 0;
   ...
   case 1:
     st7735WriteData(MADCTL_MY | MADCTL_MV | MADCTL_RGB);
     _width  = _TFTHEIGHT;
     _height = _TFTWIDTH;
     colstart = 0;
     rowstart = 0;
  ...
  case 2:
   ...
   case 3:
     st7735WriteData(MADCTL_MX | MADCTL_MV | MADCTL_RGB);
     _width  = _TFTHEIGHT;
     _height = _TFTWIDTH;
     colstart = 0;
     rowstart = 0;
