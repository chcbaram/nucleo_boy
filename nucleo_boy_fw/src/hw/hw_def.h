...
#define _HW_DEF_BUTTON_UP                 0
#define _HW_DEF_BUTTON_DOWN               1
#define _HW_DEF_BUTTON_LEFT               2
#define _HW_DEF_BUTTON_RIGHT              3
#define _HW_DEF_BUTTON_A                  4
#define _HW_DEF_BUTTON_B                  5
#define _HW_DEF_BUTTON_START              6
#define _HW_DEF_BUTTON_SELECT             7
