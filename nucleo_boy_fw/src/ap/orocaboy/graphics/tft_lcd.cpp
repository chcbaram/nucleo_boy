...
tftLCD::tftLCD() : Graphics(160, 128)
{
...
void tftLCD::drawBufferedLine(int16_t x, int16_t y, uint16_t *buffer, uint16_t w, Image& img) {
...
//boundary check must be made prior to this function
//the color must be formated as the destination
void tftLCD::drawBuffer(int16_t x, int16_t y, uint16_t *buffer, uint16_t w, uint16_t h) {
...
//boundary check must be made prior to this function
//the color must be formated as the destination
void tftLCD::sendBuffer(uint16_t *buffer, uint16_t n) {
...
void tftLCD::drawImage(int16_t x, int16_t y, Image& img){
	img.nextFrame();
...
void tftLCD::drawImage(int16_t x, int16_t y, Image& img, int16_t w2, int16_t h2) {
	img.nextFrame();
	//out of screen
...
void tftLCD::_drawPixel(int16_t x, int16_t y) {
...
void tftLCD::drawFastVLine(int16_t x, int16_t y, int16_t h) {
...
void tftLCD::drawFastHLine(int16_t x, int16_t y, int16_t w) {
	// Rudimentary clipping
	if((x >= _width) || (y >= _height)) return;
...
// fill a rectangle
void tftLCD::fillRect(int16_t x, int16_t y, int16_t w, int16_t h) {
...
void tftLCD::invertDisplay(boolean i) {
